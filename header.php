	...
	<div class="header">
		<div class="head">
			...
			<div class="restoran">
				...
				<b class="restoran-txt">4.9</b> <img src="assets/image/star.png" alt=""><b class="restoran-txt">Время доставки</b> <img src="assets/image/Ellipse.png" alt=""><b class="restoran-txt"> от 30 мин</b>
			</div>
			<div class="zvonok">
