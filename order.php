		...
		<div class="delivery-order wow zoomIn">
			<div class="order-info">
				<div class="label-order">
					<p>Имя</p>
					<input type="text" name="" placeholder="Дмитрий" readonly id="input-name-order" class="order-input">
				</div>
				<div class="label-order">
					<p>Номер телефона</p>
					<input type="tel" name="" placeholder="+7 999 999-99-99" readonly id="input-name-order" class="order-input">
				</div>
				<div class="label-order">
					<p>Адрес доставки</p>
					<input type="text" name="" placeholder="ул.Ленина 12 б" readonly id="input-name-order" class="order-input">
					<button onclick="button1Click()" class="btn-order-change">Изменить</button>
				</div>
				<div class="label-order">
					<p>Время доставки</p>
